...
const PRIMARY_FIX_LABEL = "Activer les protections";

export function DefenderMaliciousBotDetectorCheck({ result, isFixBusy, onFix }) {
	const payload = result.payload || {};
	const rows = [
		["Piège robots.txt", Boolean(payload.trapRobotsTxt)],
		["Faux bots", Boolean(payload.catchFakeBots)],
		["Headers vides", Boolean(payload.emptyHeaders)],
	];
