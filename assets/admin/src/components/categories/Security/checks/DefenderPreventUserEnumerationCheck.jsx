...
const PRIMARY_FIX_LABEL = "Activer la protection";

export function DefenderPreventUserEnumerationCheck({ result, isFixBusy, onFix }) {
	const payload = result.payload || {};
	const rows = [
		["REST API utilisateurs", Boolean(payload.restApi)],
		["oEmbed auteur", Boolean(payload.oembed)],
		["Sitemap auteurs", Boolean(payload.authorSitemap)],
	];
