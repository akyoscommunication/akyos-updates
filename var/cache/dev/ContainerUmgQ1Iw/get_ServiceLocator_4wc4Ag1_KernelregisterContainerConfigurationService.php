 ...
 */
class get_ServiceLocator_4wc4Ag1_KernelregisterContainerConfigurationService extends AkyosUpdates_KernelDevDebugContainer
{
    /**
    ...
    {
        return $container->privates['.service_locator.4wc4Ag1.kernel::registerContainerConfiguration()'] = (new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        ]))->withContext('kernel::registerContainerConfiguration()', $container);
    }
}
