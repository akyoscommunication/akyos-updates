...
readonly class PluginGitignoreService
{
    ...
    public function getGitignoreFile(): array
    {
        ...
        if ($gitignore) {
            $gitIgnoreMessage = "✅ Le fichier .gitignore est présent à la racine du site <br>";
        } else {
            $gitIgnoreMessage = "⭕ Le fichier .gitignore n'est pas présent à la racine du site <br>";
        }
    ...
    public function getGitIgnoreConfigurations(): array
    {
        ...
        if (count($notInGitignore) === 0) {
            $gitIgnoreMessage = "✅ Tous les éléments sont présents dans le fichier .gitignore";
        } else {
            $gitIgnoreMessage = "⭕ Ces éléments ne sont pas présents dans le fichier .gitignore : <br> <ul>";
